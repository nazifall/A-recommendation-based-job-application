...
public class OneFragment extends Fragment {
    ...
    class AsyncKeySearch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                String url= URL.recommendation;
                Log.e("url:", "url :"+url);
                String MyJson = key_search_Json(UserID,CategoryID);
                ...
                public void run() {
                    ...
                    try{
                        ...
                        if (response!= null)
                        {
                            ...
                            List = jsonObj.getJSONArray("search_details_list");
                            itemList.clear();
...
//                                LoginStatus=c.getString("status");
    ...
    public String key_search_Json(String user_id, String category_id)
    {
