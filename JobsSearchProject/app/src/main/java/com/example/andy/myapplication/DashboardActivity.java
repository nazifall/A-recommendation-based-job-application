...
//        getSupportActionBar().hide();
        ...
        KeySearch = extras.getString("KeySearch");


        SharedPreferences prefs = getSharedPreferences("MyPrefsFile", MODE_PRIVATE);
        UserID = prefs.getString("id", "No id defined");
         CategoryID = prefs.getString("category_id", "No category_id defined");
        ...
        Lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent idn = new Intent(DashboardActivity.this,JobDetailsActivity.class);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id){
                    ...
                    case R.id.it :
                         idn = new Intent(DashboardActivity.this, CategoryListWiseActivity.class);
    ...
    class AsyncKeySearch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                String url= URL.get_job_details_list;
                Log.e("url:", "url :"+url);
                String MyJson = key_search_Json(KeySearch,UserID,CategoryID);
...
//                                LoginStatus=c.getString("status");
    ...
    public String key_search_Json(String key_search,String user_id,String category_id)
    {
        ...
        try {
            jsonObject.accumulate("category_name", key_search);
